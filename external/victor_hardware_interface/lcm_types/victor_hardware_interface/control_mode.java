...
public final class control_mode implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(victor_hardware_interface.control_mode.class))
            return 0L;
 
        classes.add(victor_hardware_interface.control_mode.class);
    ...
    public static victor_hardware_interface.control_mode _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        victor_hardware_interface.control_mode o = new victor_hardware_interface.control_mode();
    ...
    public victor_hardware_interface.control_mode copy()
    {
        victor_hardware_interface.control_mode outobj = new victor_hardware_interface.control_mode();
