...
public final class robotiq_3finger_actuator_command implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(victor_hardware_interface.robotiq_3finger_actuator_command.class))
            return 0L;
 
        classes.add(victor_hardware_interface.robotiq_3finger_actuator_command.class);
    ...
    public static victor_hardware_interface.robotiq_3finger_actuator_command _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        victor_hardware_interface.robotiq_3finger_actuator_command o = new victor_hardware_interface.robotiq_3finger_actuator_command();
    ...
    public victor_hardware_interface.robotiq_3finger_actuator_command copy()
    {
        victor_hardware_interface.robotiq_3finger_actuator_command outobj = new victor_hardware_interface.robotiq_3finger_actuator_command();
