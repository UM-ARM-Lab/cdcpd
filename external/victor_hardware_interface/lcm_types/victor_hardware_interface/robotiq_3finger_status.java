...
public final class robotiq_3finger_status implements lcm.lcm.LCMEncodable
{
    ...
    public victor_hardware_interface.robotiq_3finger_actuator_status finger_a_status;
    public victor_hardware_interface.robotiq_3finger_actuator_status finger_b_status;
    public victor_hardware_interface.robotiq_3finger_actuator_status finger_c_status;
    public victor_hardware_interface.robotiq_3finger_actuator_status scissor_status;
    public victor_hardware_interface.robotiq_3finger_object_status finger_a_object_status;
    public victor_hardware_interface.robotiq_3finger_object_status finger_b_object_status;
    public victor_hardware_interface.robotiq_3finger_object_status finger_c_object_status;
    public victor_hardware_interface.robotiq_3finger_object_status scissor_object_status;
    ...
    {
        if (classes.contains(victor_hardware_interface.robotiq_3finger_status.class))
            return 0L;
 
        classes.add(victor_hardware_interface.robotiq_3finger_status.class);
        long hash = LCM_FINGERPRINT_BASE
             + victor_hardware_interface.robotiq_3finger_actuator_status._hashRecursive(classes)
             + victor_hardware_interface.robotiq_3finger_actuator_status._hashRecursive(classes)
             + victor_hardware_interface.robotiq_3finger_actuator_status._hashRecursive(classes)
             + victor_hardware_interface.robotiq_3finger_actuator_status._hashRecursive(classes)
             + victor_hardware_interface.robotiq_3finger_object_status._hashRecursive(classes)
             + victor_hardware_interface.robotiq_3finger_object_status._hashRecursive(classes)
             + victor_hardware_interface.robotiq_3finger_object_status._hashRecursive(classes)
             + victor_hardware_interface.robotiq_3finger_object_status._hashRecursive(classes)
            ;
    ...
    public static victor_hardware_interface.robotiq_3finger_status _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        victor_hardware_interface.robotiq_3finger_status o = new victor_hardware_interface.robotiq_3finger_status();
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.finger_a_status = victor_hardware_interface.robotiq_3finger_actuator_status._decodeRecursiveFactory(ins);
 
        this.finger_b_status = victor_hardware_interface.robotiq_3finger_actuator_status._decodeRecursiveFactory(ins);
 
        this.finger_c_status = victor_hardware_interface.robotiq_3finger_actuator_status._decodeRecursiveFactory(ins);
 
        this.scissor_status = victor_hardware_interface.robotiq_3finger_actuator_status._decodeRecursiveFactory(ins);
 
        this.finger_a_object_status = victor_hardware_interface.robotiq_3finger_object_status._decodeRecursiveFactory(ins);
 
        this.finger_b_object_status = victor_hardware_interface.robotiq_3finger_object_status._decodeRecursiveFactory(ins);
 
        this.finger_c_object_status = victor_hardware_interface.robotiq_3finger_object_status._decodeRecursiveFactory(ins);
 
        this.scissor_object_status = victor_hardware_interface.robotiq_3finger_object_status._decodeRecursiveFactory(ins);
    ...
    public victor_hardware_interface.robotiq_3finger_status copy()
    {
        victor_hardware_interface.robotiq_3finger_status outobj = new victor_hardware_interface.robotiq_3finger_status();
