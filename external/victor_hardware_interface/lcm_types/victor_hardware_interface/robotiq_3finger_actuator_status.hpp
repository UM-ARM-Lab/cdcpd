...
#ifndef __victor_hardware_interface_robotiq_3finger_actuator_status_hpp__
#define __victor_hardware_interface_robotiq_3finger_actuator_status_hpp__
...
class robotiq_3finger_actuator_status
{
    ...
    public:
        ...
        /**
         * Returns "robotiq_3finger_actuator_status"
         */
...
int robotiq_3finger_actuator_status::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int robotiq_3finger_actuator_status::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int robotiq_3finger_actuator_status::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t robotiq_3finger_actuator_status::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* robotiq_3finger_actuator_status::getTypeName()
{
    return "robotiq_3finger_actuator_status";
}

int robotiq_3finger_actuator_status::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int robotiq_3finger_actuator_status::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
