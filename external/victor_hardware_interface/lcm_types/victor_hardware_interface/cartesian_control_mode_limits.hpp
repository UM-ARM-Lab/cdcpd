...
#ifndef __victor_hardware_interface_cartesian_control_mode_limits_hpp__
#define __victor_hardware_interface_cartesian_control_mode_limits_hpp__
...
{
    public:
        victor_hardware_interface::cartesian_value_quantity max_path_deviation;

        victor_hardware_interface::cartesian_value_quantity max_cartesian_velocity;

        victor_hardware_interface::cartesian_value_quantity max_control_force;
...
int cartesian_control_mode_limits::getEncodedSize() const
{
...
const char* cartesian_control_mode_limits::getTypeName()
{
    return "cartesian_control_mode_limits";
}
...
uint64_t cartesian_control_mode_limits::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == cartesian_control_mode_limits::getHash)
            return 0;
