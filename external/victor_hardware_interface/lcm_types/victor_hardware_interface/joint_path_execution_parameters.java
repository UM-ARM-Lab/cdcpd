...
public final class joint_path_execution_parameters implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(victor_hardware_interface.joint_path_execution_parameters.class))
            return 0L;
 
        classes.add(victor_hardware_interface.joint_path_execution_parameters.class);
    ...
    public static victor_hardware_interface.joint_path_execution_parameters _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        victor_hardware_interface.joint_path_execution_parameters o = new victor_hardware_interface.joint_path_execution_parameters();
    ...
    public victor_hardware_interface.joint_path_execution_parameters copy()
    {
        victor_hardware_interface.joint_path_execution_parameters outobj = new victor_hardware_interface.joint_path_execution_parameters();
