...
def mengyao_run_trials(experiment, generate_screenshots="false", log_prefix=""):
        ...
        down_scale_range = [400, 1000, 2500]
        stretching_threshold_range = [0.4, 0.5, 0.75]
                    ...
                    for trans_dir_deformability in trans_dir_deformability_range:
                        for down_scale in down_scale_range:
                            mengyao_run_trial(experiment=experiment,
                                              ...
                                              test_id=log_prefix + "MM_test_fixed_step/" + "desired_down_" + str(down_scale) + "/cos_" + str(stretching_threshold) + "/_dir" + str(trans_dir_deformability) + "_dis" + str(trans_dis_deformability) + "_rot" + str(rotation_deformability),
