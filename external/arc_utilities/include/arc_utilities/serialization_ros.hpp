...
inline uint64_t SerializeHeader(const std_msgs::Header& header, std::vector<uint8_t>& buffer) {
...
inline std::pair<std_msgs::Header, uint64_t> DeserializeHeader(const std::vector<uint8_t>& buffer,
...
inline uint64_t SerializePoint(const geometry_msgs::Point& point, std::vector<uint8_t>& buffer) {
  uint64_t bytes_written = 0;
...
inline std::pair<geometry_msgs::Point, uint64_t> DeserializePoint(const std::vector<uint8_t>& buffer,
                                                                  const uint64_t current) {
...
inline uint64_t SerializeVector3(const geometry_msgs::Vector3& vector, std::vector<uint8_t>& buffer) {
  uint64_t bytes_written = 0;
...
inline std::pair<geometry_msgs::Vector3, uint64_t> DeserializeVector3(const std::vector<uint8_t>& buffer,
                                                                      const uint64_t current) {
...
inline uint64_t SerializeQuaternion(const geometry_msgs::Quaternion& quat, std::vector<uint8_t>& buffer) {
  uint64_t bytes_written = 0;
...
inline std::pair<geometry_msgs::Quaternion, uint64_t> DeserializeQuaternion(const std::vector<uint8_t>& buffer,
                                                                            const uint64_t current) {
...
inline uint64_t SerializePose(const geometry_msgs::Pose& pose, std::vector<uint8_t>& buffer) {
  uint64_t bytes_written = 0;
...
inline std::pair<geometry_msgs::Pose, uint64_t> DeserializePose(const std::vector<uint8_t>& buffer,
                                                                const uint64_t current) {
...
inline uint64_t SerializePoseStamped(const geometry_msgs::PoseStamped& pose, std::vector<uint8_t>& buffer) {
  uint64_t bytes_written = 0;
...
inline std::pair<geometry_msgs::PoseStamped, uint64_t> DeserializePoseStamped(const std::vector<uint8_t>& buffer,
                                                                              const uint64_t current) {
...
inline uint64_t SerializeTransform(const geometry_msgs::Transform& transform, std::vector<uint8_t>& buffer) {
  uint64_t bytes_written = 0;
...
inline std::pair<geometry_msgs::Transform, uint64_t> DeserializeTransform(const std::vector<uint8_t>& buffer,
                                                                          const uint64_t current) {
...
inline uint64_t SerializeTransformStamped(const geometry_msgs::TransformStamped& transform,
...
inline uint64_t RosMessageSerializationWrapper(const MessageType& message, std::vector<uint8_t>& buffer) {
  const ros::SerializedMessage serialized_message = ros::serialization::serializeMessage(message);
  buffer.insert(buffer.end(), serialized_message.message_start,
                serialized_message.message_start + serialized_message.num_bytes);
  return serialized_message.num_bytes;
}

template <typename MessageType>
inline std::pair<MessageType, uint64_t> RosMessageDeserializationWrapper(const std::vector<uint8_t>& buffer,
                                                                         const uint64_t current) {
  ...
  // This is used by serializeMessage to store the total size of the message in the buffer (excluding this length
  // marker)
